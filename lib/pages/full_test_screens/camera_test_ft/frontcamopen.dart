...
class FrontCameraOpenHT extends StatefulWidget {
   final List<CameraDescription>? cameras;
  const FrontCameraOpenHT({this.cameras,Key? key}) : super(key: key);

  @override
  State<FrontCameraOpenHT> createState() => _FrontCameraOpenHTState();
}

class _FrontCameraOpenHTState extends State<FrontCameraOpenHT> {
          ...
          Padding(
            ...
            await availableCameras().then(
              (value) => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) =>FrontCameraHT(cameras: value,),
                ),
              ),
            );
          },
