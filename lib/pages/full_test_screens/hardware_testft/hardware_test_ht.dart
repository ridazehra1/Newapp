...
class HardwareTestFT extends StatefulWidget {
  const HardwareTestFT({Key? key}) : super(key: key);

  @override
  State<HardwareTestFT> createState() => _HardwareTestFTState();
}

class _HardwareTestFTState extends State<HardwareTestFT> {
  @override
