...
import 'package:diagnose/pages/full_test_screens/screen_testft/screen_analysisft.dart';
...
class FullTest extends StatefulWidget {
  const FullTest({Key? key}) : super(key: key);

  @override
  State<FullTest> createState() => _FullTestState();
}

class _FullTestState extends State<FullTest> {
  @override
