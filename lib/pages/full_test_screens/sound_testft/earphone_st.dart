...
class EarPieceST extends StatefulWidget {
  const EarPieceST({Key? key}) : super(key: key);
  @override
  State<EarPieceST> createState() => _EarPieceSTState();
}

class _EarPieceSTState extends State<EarPieceST> {
  @override
