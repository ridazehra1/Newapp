...
import 'package:diagnose/pages/quick_test_screens/back_camera.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:page_transition/page_transition.dart';

class BackCameraOpne extends StatefulWidget {
  const BackCameraOpne({Key? key}) : super(key: key);

  @override
  State<BackCameraOpne> createState() => _BackCameraOpneState();
}

class _BackCameraOpneState extends State<BackCameraOpne> {
  @override
          ...
          Padding(
            ...
            await availableCameras().then(
              (value) => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => BackCamera(cameras: value,),
                ),
              ),
            );
          },
