...
class SuccessSpeaker extends StatefulWidget {
  const SuccessSpeaker({Key? key}) : super(key: key);

  @override
  State<SuccessSpeaker> createState() => _SuccessSpeakerState();
}

class _SuccessSpeakerState extends State<SuccessSpeaker> {
  @override
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Speaker is working but how much !\nit’s on sound qulity which you are\nlistning',
            textAlign: TextAlign.center,
            style: TextStyle(
                color: Color.fromRGBO(255, 255, 255, 1),
